...
let item = countries[random]
    bigcard += `<div class="big-card-img">
                ...
                <div class="big-card-content">
                    ...
                    <h5>Area: ${item.area} km2</h5>
                    <h5>Population: ${item.population}</h5>
                </div>`

bigCard.innerHTML = bigcard
    ...
    let item = countries[i]
        code += `<div class="card">
                ...
                <div class="card-content">
                    <p class="continent">${item.region}</p>
                    <h3>${item.name}, <span class="italic">${item.capital}</span></h3>
                    <div class="pop">
